...
%Función para calcular la segunda derivada temporal jacobiano de las 5 ecuaciones
%de restricción de sólido rígido definido entre 4 puntos (1, 2 y 3 no
%alineados)

%Entradas
%p (Vector fila 13x1 con las posiciones de las coordenadas utilizadas en las ecuaciones en el
%vector q global: [nx1 ny1 nx2 ny2 nx3 ny3 nx4 ny4 nL12 nL13 nL23 lambda4 mu4]. Si la posición es negativa, quiere decir que
...
%Salidas
%d2jacphi (Matriz 5xn con la segunda derivada temporal del jacobiano de las ecuaciones de restricción)
...
%Calcular la segunda derivada temporal del jacobiano de las ecuaciones de restricción
    d2jacphi=zeros(5,n);
    if 0<p(1)
