...
%Función para calcular la derivada temporal del jacobiano de las 6 ecuaciones
%de restricción que definen un sólido rígido con una base ortogonal de 3 vectores
%unitarios
...
%Salidas
%djacphi (Matriz 6xn con la derivada temporal del jacobiano de las ecuaciones de restricción)
