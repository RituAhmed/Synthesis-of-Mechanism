function djacphi=djacphi_rs3p(p,q,dq,c)
%Función para calcular la derivada temporal del jacobiano de las 3 ecuaciones
%de restricción de sólido rígido definido entre 3 puntos no alineados
...
%Calcular el jacobiano de las ecuaciones de restricción
    ...
    if 0<p(1)
        ...
        djacphi(2,p(1))=-2*(dx3-dx1);
    end
    
    if 0<p(2)
        djacphi(1,p(2))=-2*(dy2-dy1);
        djacphi(2,p(2))=-2*(dy3-dy1);
    end
    
    if 0<p(3)
        djacphi(1,p(3))=2*(dx2-dx1);
        djacphi(3,p(3))=-2*(dx3-dx2);
    end
    
    if 0<p(4)
        djacphi(1,p(4))=2*(dy2-dy1);
        djacphi(3,p(4))=-2*(dy3-dy2);
    end
    
    if 0<p(5)
        djacphi(2,p(5))=2*(dx3-dx1);
        djacphi(3,p(5))=2*(dx3-dx2);
    end
    
    if 0<p(6)
        djacphi(2,p(6))=2*(dy3-dy1);
        djacphi(3,p(6))=2*(dy3-dy2);
    end
